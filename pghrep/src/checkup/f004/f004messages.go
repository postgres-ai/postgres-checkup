...
const MSG_BLOAT_WARNING_RECOMMENDATION_TABLES string = "The following tables have estimated bloat > %.2f%%: %s. Use this list to reduce the bloat applying one of the approaches described below."
