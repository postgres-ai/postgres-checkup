...
const MSG_RISKS_ARE_HIGH_CONCLUSION string = "[P1] Risks of transaction ID wraparound are high for:  \n" +
	...
	"More on this topic:  \n" +
	"- [PostgreSQL Documentation. 24.1.5. Preventing Transaction ID Wraparound Failures](https://www.postgresql.org/docs/)  \n" + //OUR_MAJOR_VERSION/routine-vacuuming.html#VACUUM-FOR-WRAPAROUND
