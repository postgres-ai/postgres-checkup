...
#### Databases data ####
{{ if gt (len (index (index (index $.results $.hosts.master) "data") "databases_stat")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ (len (index (index (index $.results $.hosts.master) "data") "databases_stat")) }}.{{ end }}  
...
#### Databases data ####
{{ if gt (len (index (index (index $.results $host) "data") "databases_stat")) $.LISTLIMIT }}The list is limited to {{$.LISTLIMIT}} items. All items {{ (len (index (index (index $.results $host) "data") "databases_stat")) }}.{{ end }}  
