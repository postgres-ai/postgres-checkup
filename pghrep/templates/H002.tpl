...
{{ if gt (len (index (index (index .results .reorderedHosts.master) "data") "never_used_indexes")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ (len (index (index (index .results .reorderedHosts.master) "data") "never_used_indexes")) }}.{{ end }}  
...
{{ if gt (len (index (index (index .results .reorderedHosts.master) "data") "rarely_used_indexes")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ (len (index (index (index .results .reorderedHosts.master) "data") "rarely_used_indexes")) }}.{{ end }}  
...
{{ if gt (len (index (index (index .results .reorderedHosts.master) "data") "redundant_indexes")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ (len (index (index (index .results .reorderedHosts.master) "data") "redundant_indexes")) }}.{{ end }}  
