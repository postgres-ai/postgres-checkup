...
### Master (`{{.hosts.master}}`) ###
{{ if ge (len (index (index (index .results .hosts.master) "data") "dead_tuples")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ Sub (len (index (index (index .results .hosts.master) "data") "dead_tuples")) 1 }}.{{ end }}  
