...
### Master (`{{.hosts.master}}`) ###
{{ if gt (len (index (index (index .results .hosts.master) "data") "dead_tuples")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ (len (index (index (index .results .hosts.master) "data") "dead_tuples")) }}.{{ end }}  
