...
{{ range $key, $value := (index .diffData "pg_settings") }}| [{{ $key }}](https://postgresqlco.nf/en/doc/param/{{ $key }}){{ range $key, $value := $value }} |{{ if and ( ne (index $value "value") "-1") ( ne (index $value "value") "0") (index $value "unit") }}{{ if (UnitValue (index $value "value") (index $value "unit")) }}{{ UnitValue (index $value "value") (index $value "unit") }}{{else}}{{(index $value "value")}} {{(index $value "unit") }}{{end}}{{else}}{{ index $value "value" }}{{ end }}{{ end }} |
{{ end }}
{{ else }}
