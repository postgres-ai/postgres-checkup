...
{{ if gt (len (index (index (index .results .hosts.master) "data") "invalid_indexes")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ (len (index (index (index .results .hosts.master) "data") "invalid_indexes")) }}.{{ end }}  
