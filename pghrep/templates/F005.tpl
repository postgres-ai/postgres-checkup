...
### Master (`{{.hosts.master}}`) ###
{{ if gt (len (index (index (index $.results $.hosts.master) "data") "index_bloat")) .LISTLIMIT }}The list is limited to {{.LISTLIMIT}} items. All items {{ (len (index (index (index $.results $.hosts.master) "data") "index_bloat")) }}. {{ end }}  
